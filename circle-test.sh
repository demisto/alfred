...
exit_if_fail touch $GOPATH/src/github.com/demisto/alfred/static/master/jade/_gtmid.json && echo '{}' >> $GOPATH/src/github.com/demisto/alfred/static/master/jade/_gtmid.json
